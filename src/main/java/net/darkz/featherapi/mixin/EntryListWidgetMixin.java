package net.darkz.featherapi.mixin;
...
import net.darkz.featherapi.gui.TransparencySprites;
import net.darkz.featherapi.utils.DrawUtils;
...
public abstract class EntryListWidgetMixin  {
	...
	private boolean renderTransparencyScrollerBackground3(GuiGraphicsExtractor instance, int x1, int y1, int x2, int y2, int color) {
		return !FeatherAPIScreen.isFeatherAPIScreen();
	}
