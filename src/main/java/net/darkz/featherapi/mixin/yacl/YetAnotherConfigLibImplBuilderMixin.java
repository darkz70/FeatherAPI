...
import net.darkz.featherapi.utils.yacl.*;
...
public class YetAnotherConfigLibImplBuilderMixin implements SimpleYACLScreenBuilder {
	...
	private YetAnotherConfigLib swapScreen(YetAnotherConfigLib original) {
		...
		return ((SimpleYACLScreenConfig) original).featherapi$setConsumer(this.consumer);
	}

	@Override
	public Builder featherapi$setConsumer(YACLScreenConsumer consumer) {
