...
import net.darkz.featherapi.yacl.api.SimpleContent;
...
public class ModMenuUtils {
	...
	public static Function<Boolean, Component> getEnabledOrDisabledFormatter() {
		return state -> FeatherAPI.text("modmenu.formatter.enabled_or_disabled." + state);
	}

	public static MutableComponent getNoConfigScreenMessage() {
		return FeatherAPI.text("modmenu.no_config_library_screen.message");
	}

	public static MutableComponent getOldConfigScreenMessage(String version) {
		return FeatherAPI.text("modmenu.old_config_library_screen.message", version, FeatherAPI.YACL_DEPEND_VERSION);
	}

	public static MutableComponent getOldConfigScreenMessage(String version, String yacl) {
		return FeatherAPI.text("modmenu.old_config_library_screen.message", version, yacl);
	}
}
